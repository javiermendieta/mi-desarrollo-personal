...
import { 
  ...
  Edit, ChevronDown, ChevronUp, Settings, List, Calendar, ArrowUpCircle, ArrowDownCircle
} from 'lucide-react';
...
export function FinanceModule() {
  ...
  // Initialize default account plan if empty
  useEffect(() => {
  ...
  }, [accountPlan.length, addAccountPlanItem]);
          ...
          <Card>
            <CardHeader>
              <div className="flex justify-between items-center">
                ...
                <Button onClick={() => openTransactionDialog(null)}>
      ...
      <Dialog open={accountDialog} onOpenChange={setAccountDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input 
                ...
                placeholder="Ej: Ventas de Productos, Alquiler, etc."
              />
            </div>
            <div>
          ...
          <DialogFooter>
            ...
            <Button onClick={saveAccount} disabled={!accountName.trim()}>Guardar</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={transactionDialog} onOpenChange={setTransactionDialog}>
        <DialogContent>
                ...
                <SelectContent>
                  {SECTION_ORDER.map(section => (
                    <div key={section}>
                      ...
                      {getAccountsBySection(section).map(account => (
          ...
          <DialogFooter>
            ...
            <Button onClick={saveTransaction} disabled={!transactionAccountId || !transactionAmount}>Guardar</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </div>
